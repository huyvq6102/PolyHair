    ...
    <div class="card-body">
        <form action="{{ route('admin.employees.store') }}" method="POST" enctype="multipart/form-data" class="needs-validation" novalidate>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="text" name="name" id="name" value="{{ old('name') }}" class="form-control @error('name') is-invalid @enderror" placeholder="Nhập tên nhân viên" required>
                        @error('name')
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="level" id="level" class="form-control @error('level') is-invalid @enderror">
                            ...
                            <option value="Intern" {{ old('level') == 'Intern' ? 'selected' : '' }}>Intern</option>
            ...
            <div class="row">
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <input type="number" name="experience_years" id="experience_years" value="{{ old('experience_years') }}" class="form-control @error('experience_years') is-invalid @enderror" placeholder="Nhập số năm kinh nghiệm" min="0" max="50">
                ...
                <div class="col-md-6">
                    <div class="form-group">
                        ...
                        <select name="status" id="status" class="form-control @error('status') is-invalid @enderror">
                            <option value="Đang làm việc" {{ old('status', 'Đang làm việc') == 'Đang làm việc' ? 'selected' : '' }}>Đang làm việc</option>
            ...
            <div class="form-group">
                ...
                <textarea name="bio" id="bio" rows="4" class="form-control @error('bio') is-invalid @enderror" placeholder="Nhập giới thiệu về nhân viên">{{ old('bio') }}</textarea>
                @error('bio')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
