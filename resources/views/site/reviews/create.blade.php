        ...
        <div class="row justify-content-center">
            <div class="col-lg-8">
                <div class="review-form-container">
                    ...
                    <form action="{{ route('site.reviews.store') }}" method="POST" enctype="multipart/form-data" id="reviewForm">
                        @csrf
                        ...
                        <div class="text-center mt-4">
                            ...
                            <a href="{{ route('site.appointment.show', $appointment->id) }}" class="btn btn-secondary btn-lg px-5 ml-2">
